...
export const HoverEffect = ({
  ...
  return (
    <div className={cn("grid grid-cols-1 md:grid-cols-2  lg:grid-cols-5  py-10", className)}>
      {items.map((item, idx) => (
        <Link
          href={item?.title}
          key={idx}
        ...
        >
          ...
          <Card>
            <CardDescription className="flex items-center justify-center w-full flex-col gap-2  ">
              {item.logo}
              {item.title}
            </CardDescription>
          </Card>
